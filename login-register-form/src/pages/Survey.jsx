    ...
    return (
        ...
        <div className="auth-form-container">
            ...
            <form className="questionnaire" onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="qf24">24. Please list at least three of your hobbies (video games, hiking, basketball, food, knitting, etc.).</label>
                    <input type="text" placeholder="" id="qf24" name="qf24"/>

                    <label htmlFor="qf25">25. Do you do your own cooking?</label>
                    <div className="dropdown">
                    ...
                    <label htmlFor="qf26">26. Would you find cooking classes helpful?</label>
                    <div className="dropdown">
                        <select name="yesorno" id="qf26">
                            <option value="yes">yes</option>
                            <option value="no">no</option>
                        </select>
                    </div>

                    <label htmlFor="qf27">27. Do you eat past the point of fullness?</label>
                    <div className="dropdown">
                        <select name="multipledropdown" id="qf27">
                            <option value="never">never</option>
                            <option value="sometimes">sometimes</option>
                            <option value="often">often</option>
                        </select>
                    ...
                    <label htmlFor="qf28">28. How many times per week do you eat out?</label>
                    <div className="dropdown">
                        <select name="multipledropdown" id="qf28">
                    ...
                    <label htmlFor="qf29">29. At work do you usually bring food or eat out?</label>
                    <div className="dropdown">
                        <select name="multipledropdown" id="qf29">
                            <option value="bring food">bring food</option>
                            <option value="eat out">eat out</option>
                        </select>
                    </div>

                    <label htmlFor="qf30">30. How many glasses of water do you consume daily?</label>
                    <div className="dropdown">
                        <select name="multipledropdown" id="qf30">
                    ...
                    <label htmlFor="qf31">31. Are you currently or have you ever taken a multivitamin or any other food supplements? Yes No
                    If yes, please list the supplements:</label>
                    <div className="dropdown">
                        <select name="yesorno" id="qf31">
                            <option value="yes">yes</option>
                            <option value="no">no</option>
                        </select>
                    </div>
                    <input type="text" placeholder="" id="qf31_2" name="qf31_2"/>
